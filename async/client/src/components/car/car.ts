...
export class Car extends BaseComponent implements ICar {
  ...
  constructor(id: string, name: string = 'Car', color: string = 'red') {
    super("div", ["car"]);
  ...
  html() {
    return `
    <svg class="car-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    viewBox="0 0 511 511" style="fill:${this.color}" xml:space="preserve">
    <g>
